...
#go build -buildmode=$MODE -ldflags="-s -w" -o ./build/$GOOS/$GOARCH/plugins/aws/glue.plugin ./aws/glue/glue.go
go build -buildmode=$MODE -ldflags="-s -w" -o ./build/$GOOS/$GOARCH/plugins/aws/ecr.plugin ./aws/ecr/ecr.go
